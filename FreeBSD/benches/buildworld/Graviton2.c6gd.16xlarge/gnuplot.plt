...
set title noenhanced "Job numbers' impact on 'make TARGET_ARCH=riscv64 buildworld' execution time\nARM Neoverse-N1 r3p1 (cores: 64, thread per core: 1, Total CPUs: 64) with 125 GB RAM\n src and obj on tmpfs"
set xlabel font "Gill Sans,16"
set xlabel noenhanced "FreeBSD/arm64 15.0-CURRENT (1500023) building main sources cloned at 6a4f0c063 (2024-09-25 15:17:16 -0700)"

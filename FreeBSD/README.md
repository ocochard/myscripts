...
- [Framework Desktop (Strix Halo) setup notes](Framework-desktop.md) — see also the cross-OS llama.cpp results in [../LLM/benches.FrameWork-Desktop.md](../LLM/benches.FrameWork-Desktop.md)
